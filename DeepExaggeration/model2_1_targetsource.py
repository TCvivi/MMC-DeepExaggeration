...
def get_default_hparams():
    ...
    hparams = tf.contrib.training.HParams(
        source = 'people5.npy',  
        target = 'cartoon5.npy', 
        sourcesTest = 'newsources5.npy',  
        targetsTest = 'newtargets5.npy',
        num_steps=1000,  # Total number of steps of training. Keep large. 迭代次数
        ...
        enc_rnn_size=512,  # Size of encoder.编码器隐藏层单元数目
        ...
        learning_rate=0.009,  # Learning rate. 学习率
