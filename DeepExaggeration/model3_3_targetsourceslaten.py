...
def get_default_hparams():
    ...
    hparams = tf.contrib.training.HParams(
        source = 'people_xk.npy',  
        target = 'cartoon_xk.npy', 
        sourcesTest = 'newestsources_xk.npy',  
        targetsTest = 'newesttargets_xk.npy',
        num_steps=20000,  # Total number of steps of training. Keep large. 迭代次数
        ...
        kl_weight=0.6,  # KL weight of loss equation. Recommend 0.5 or 1.0. KL距离的权重
